...
#endif
    {
        Image image = LoadImageRL(fileName);
...
void DrawFPS(int posX, int posY)
{
    ...
    DrawTextRL(TextFormat("%2i FPS", GetFPS()), posX, posY, 20, color);
}
...
void DrawTextRL(const char *text, int posX, int posY, int fontSize, Color color)
{
    ...
    if (GetFontDefault().texture.id != 0)
    {
        ...
        DrawTextExRL(GetFontDefault(), text, position, (float)fontSize, (float)spacing, color);
    }
}

// Draw text using Font
// NOTE: chars spacing is NOT proportional to fontSize
void DrawTextExRL(Font font, const char *text, Vector2 position, float fontSize, float spacing, Color tint)
{
...
void DrawTextPro(Font font, const char *text, Vector2 position, Vector2 origin, float rotation, float fontSize, float spacing, Color tint)
{
    rlPushMatrix();
        ...
        DrawTextExRL(font, text, (Vector2){ 0.0f, 0.0f }, fontSize, spacing, tint);
...
static Font LoadBMFont(const char *fileName)
{
    ...
    Image imFont = LoadImageRL(imPath);
