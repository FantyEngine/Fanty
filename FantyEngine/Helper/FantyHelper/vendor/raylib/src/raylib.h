...
RLAPI void* GetWindowGlfw();
RLAPI void CallWindowResize();
...
RLAPI Image LoadImageRL(const char *fileName);                                                             // Load image from file into CPU memory (RAM)
...
RLAPI void DrawTextExRL(Font font, const char *text, Vector2 position, float fontSize, float spacing, Color tint); // Draw text using font and additional parameters
